...
INSERT INTO students(student_age, student_id) VALUES(20, 106);
--UNIQUE constraint can not have dublicate values but it can have duplicate 'null'
...
--Update the dob of Ali Can to 11-Dec-1997
UPDATE students
